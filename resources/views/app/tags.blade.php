                ...
                <div class="row">
                    <div class="col-md-12 main_title_col">
                        <div class="jl_cat_mid_title">
                            ...
                            <h3 class="categories-title title">#Business</h3>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="post_grid_content_wrapper">
                                        <div class="image-post-thumb">
                                            <a href="#" class="link_image featured-thumbnail" title="Round white dining table on brown hardwood">
                                                <img src="http://jellywp.com/theme/disto/demo/wp-content/uploads/2019/02/roberto-nickson-1299738-unsplash-780x450.jpg" class="attachment-disto_large_feature_image size-disto_large_feature_image wp-post-image" alt="" />         <div class="background_over_image"></div>
                                            </a>
