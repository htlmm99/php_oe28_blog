                     ...
                     <div class="jellywp_about_us_widget_wrapper">
                        ...
                        <div class="social_icons_widget">
                           <ul class="social-icons-list-widget icons_about_widget_display">
                              <li><a href="{{ config('common.soical.facebook') }}" class="facebook" target="_blank"><i class="fa fa-facebook"></i></a>
                              </li>
                              <li><a href="{{ config('common.soical.youtube') }}" class="youtube" target="_blank"><i class="fa fa-youtube"></i></a>
                              </li>
